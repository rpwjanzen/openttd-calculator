...
export const allEngines: Engine[] = [
    {
        ...
        // units on page use Metric Tonne, not Short Ton (even though mph and hp are used).
        mass: Mass.Tonne(35),
        ...
        role: Role.LightGeneralPurposeExpress,
    ...
    },
    {
        ...
        maxSpeed: Speed.MilesPerHour(120),
        power: Power.Hp(1650),
        mass: Mass.Tonne(74),
        gauge: TrackGauge.standard,
...

    {
        ...
        role: Role.LightGeneralPurposeExpressJoker,
        generation: Generation.second,
        maxSpeed: Speed.MilesPerHour(75),
        power: Power.Hp(650),
        mass: Mass.Tonne(54),
